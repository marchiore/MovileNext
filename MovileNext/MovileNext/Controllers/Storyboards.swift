...
struct Storyboards {
    ...
    struct Main {
        ...
        static func instantiateInitialViewController() -> CustomNavigationControllerViewController! {
            return self.storyboard.instantiateInitialViewController() as! CustomNavigationControllerViewController
        }
...
//MARK: - CustomNavigationControllerViewController
